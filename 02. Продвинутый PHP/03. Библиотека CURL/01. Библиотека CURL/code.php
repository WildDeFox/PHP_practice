...
// 	curl_setopt($curl, CURLOPT_USERAGENT, 'Mozilla/4.04. Модификаторы доступа public и private (compatible; MSIE 7.04. Модификаторы доступа public и private; Windows NT 5.1)');
